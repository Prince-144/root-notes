/**
 * Trims two JSCeal paragraphs back under the overflow threshold.
 *
 *   npx tsx --env-file=.env.local scripts/fix-jsceal-overflow.ts --apply
 *
 * The reshape landed them at 497 and 467 characters, which is past the 420 the
 * scorer penalises and past what a slide renders without cutting off. Caught
 * from the score output this time rather than from a truncated card.
 *
